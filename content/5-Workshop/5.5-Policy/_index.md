...
![Status of the NeonFoodMap backend ECR repository](images/picECR1.jpg)

- **neonfoodmap-frontend:** stores images pulled when the frontend service is deployed.

![Status of the NeonFoodMap frontend ECR repository](images/picECR2.jpg)
...
![NeonFoodMap ECS cluster and service status](images/picECSCheck2.jpg)
...
![NeonFoodMap ECS tasks and services](images/picECSCheck3.jpg)
...
![CloudWatch logs and backend ECS service health checks](images/picECSCheck1.jpg)
...
![NeonFoodMap CI/CD pipeline](images/picCICD3.jpg)
...
![Backend ECS deployment result](images/picCICD1.jpg)
...
![Frontend ECS deployment result](images/picCICD2.jpg)
...
![ALB routing and healthy targets](images/picALB.jpg)
...
![CloudWatch alarms overview](images/CloudWatchOverview.jpg)
...
![CloudWatch ECS metrics](images/CloudWatchECS.jpg)
...
![CloudWatch ALB metrics](images/CloudWatchALB.jpg)
