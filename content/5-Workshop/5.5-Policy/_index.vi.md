...
![Trạng thái ECR repository neonfoodmap backend](images/picECR1.jpg)

- **neonfoodmap-frontend:** Các đợt pull image tương ứng với lịch trình deployment của frontend service.

![Trạng thái ECR repository neonfoodmap frontend](images/picECR2.jpg)
...
![Trạng thái NeonFoodmap ECS cluster và services](images/picECSCheck2.jpg)
...
![Trạng thái NeonFoodmap ECS cluster và services](images/picECSCheck3.jpg)
...
![CloudWatch logs và health check backend ECS service](images/picECSCheck1.jpg)
...
![picCICDPipeline3](images/picCICD3.jpg)
...
![picCICDPipeline2](images/picCICD1.jpg)
...
![picCICDPipeline2](images/picCICD2.jpg)
...
![CloudWatchECS](images/CloudWatchECS.jpg)
...
![CloudWatchALB](images/CloudWatchALB.jpg)
