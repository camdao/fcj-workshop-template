...
![picCreateECS12](/5-Workshop/images/5.4-Neon-Deployment/image039.png)

3. Trong phần networking, chọn VPC và các **private subnet** của ứng dụng, chọn ECS task security group.

![image040](/5-Workshop/images/5.4-Neon-Deployment/image040.png)
...
![image041](/5-Workshop/images/5.4-Neon-Deployment/image041.png)

5. Kiểm tra cấu hình, chọn **Create**. ECS sẽ tự tạo task, đăng ký IP task vào frontend target group và Cloud Map.

![image042](/5-Workshop/images/5.4-Neon-Deployment/image042.png)
...
![image043](/5-Workshop/images/5.4-Neon-Deployment/image043.png)
...
![image003](/5-Workshop/images/5.5-Neon-Operations/image003.png)
...
![image001](/5-Workshop/images/5.5-Neon-Operations/image001.png)

Sau khi lưu, policy `cpu-70-target-tracking` sẽ theo dõi CPU của service trong giới hạn từ `2` đến `6` task.

![image009](/5-Workshop/images/5.5-Neon-Operations/image009.png)

![image007](/5-Workshop/images/5.5-Neon-Operations/image007.png)
