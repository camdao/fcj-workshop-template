...
![create stack](/5-Workshop/images/5.2-Prerequisite/create-stack1.png)

+ Lựa chọn 2 mục acknowledgement 
+ Chọn Create stack

![create stack](/5-Workshop/images/5.2-Prerequisite/create-stack2.png)

Quá trình triển khai CloudFormation cần khoảng 15 phút để hoàn thành.

![complete](/5-Workshop/images/5.2-Prerequisite/complete.png)

+ 2 VPCs đã được tạo

![vpcs](/5-Workshop/images/5.2-Prerequisite/vpcs.png)

+ 3 EC2s đã được tạo

![EC2](/5-Workshop/images/5.2-Prerequisite/ec2.png)