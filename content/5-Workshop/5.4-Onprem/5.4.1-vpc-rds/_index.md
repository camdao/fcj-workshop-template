---
title: "VPC and MySQL RDS Foundation"
date: 2026-08-03
weight: 1
chapter: false
pre: " <b> 5.4.1. </b> "
...
![Create VPC](images/picCreateVPC1.jpg)
...
![Completed VPC and NAT Gateway](images/picVPC.jpg)
...
![Completed RDS database](images/picFinalRDS1.jpg)
![DB subnet group](images/picDbSubnetGroup.jpg)

![RDS parameter group](images/picParameterGroup.jpg)

![RDS security group](images/picSecurityGroup.jpg)

![Create RDS database, connectivity](images/picCreateRDS1.jpg)

![Create RDS database, additional configuration](images/picCreateRDS2.jpg)

![Final RDS database settings](images/picFinalRDS2.jpg)
